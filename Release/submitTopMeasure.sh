...
~/bin/submitCondor -o TTLL -f filelist_DY10to50.txt $1
...
~/bin/submitCondor -o ST_tW_antitop -f filelist_ST_tW_antitop.txt $1
...
echo "Now waiting next job for TT mass 166.5"
~/bin/submitCondor -o TT_mass_1665 -f filelist_TT_mass_1665.txt $1
TMASS4=`ls -td TT_mass_1665*/ | head -n 1 | cut -d'/' -f1`  
cd ${TMASS1}
condor_submit run.jdl
cd ..
